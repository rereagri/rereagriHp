<template>
  <v-container>
    ...
    <br>
    <v-row justify="center">
      <p>※一般社団法人リリアグリは2024年４月１日をもって休業しました。</p>
    </v-row>
    <br><br>
    <v-row justify="center">
      <v-btn outlined rounded color="green" style="font-weight: bold;" @click="$router.push('/blog')">
        <a style="color: green;" target="_blank">内藤農園のブログ</a>
      </v-btn>
    </v-row>
    <br>
    <br>
    ...
    <v-row justify="center">
      <v-btn outlined rounded color="orange" style="font-weight: bold;">
        ...
        <v-container>
          <v-card ref="card" class="mb-3" color="blue lighten-4">
            <v-card-text class="text-center">
              ...
              <a href="mailto:dtmservice0701@gmail.com">運営へのメールはこちらから<br>（タグの提案もこちらから受け付けます）</a>
            </v-card-text>
          </v-card>
        </v-container>
      </v-col>
